...
(** [is_conditional_jump instr] Detects if the instruction is a
    conditional jump with heuristic: conditional jump has multiple
    outer targets. **)
val is_conditional_jump: t -> bool

(** [is_return instr] check if instruction [instr] encodes a return *)
